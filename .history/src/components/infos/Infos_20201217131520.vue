  ...
  <Container>
    <Content>
      <Items>
        <Item>
          <span>
            <Icon class="material-icons">advanced_devices</Icon>
          </span>
          <Description>
            <TextDescription>Preços exclusivos para site e app</TextDescription>
          </Description>
        </Item>
        <Item>
...
<script>
import { Container, Content, Item, Description, History, Items, Icon, TextDescription } from './style.js'

export default {
  name: 'Infos',
  components: {
    Container, Content, Item, Description, History, Items, Icon, TextDescription
  }
}
</script>
